...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sll    , R, R(dest) = (int)src1 << src2);
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , M, printf("%llx %x\n", (long long)src1 * (long long)src2, (word_t)(((long long)((long long)src1*(long long)src2))>>32)), R(dest) = (word_t)(((long long)((long long)src1 * (long long)src2)) >> 32));
